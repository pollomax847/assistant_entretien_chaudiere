...
const reglementationGazModule = (function() {
    ...
    const reglementationQuestions = [
        ...
        },
        {
            id: 'q8a',
            category: 'Sécurité',
            question: 'Le système d\'arrêt de sécurité gaz intervient-il dans les 36 secondes?',
            reference: 'Arrêté du 23/02/2018 - Art. 11 / NF DTU 61.1',
            info: 'L\'arrêt de sécurité gaz (thermocouple ou ionisation) doit couper l\'alimentation gaz dans un délai maximum de 36 secondes en cas d\'extinction de flamme.',
            critical: true
        },
        {
            id: 'q9',
